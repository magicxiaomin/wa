...
> 历史说明：本文最初服务于第一波桌面 PoC。当前 Wave 4 MVP research mode 已经允许 raw trace/debug
> 记录完整业务字段和认证调试材料。当前审计以 `SPEC_WAVE4.md`、`ACCEPTANCE_WAVE4.md`、
> `TRACE_SCHEMA.md` 为准。
...
ExportTrace(path string) error  // 导出 trace.json；Wave 4 MVP research mode 为 raw trace/debug
